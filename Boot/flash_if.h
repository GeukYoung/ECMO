...
#define BOOT_FLASH_ADDR       ADDR_FLASH_PAGE_0
#define BOOT_PARAM_ADDR       ADDR_FLASH_PAGE_17

#define APP_FLASH_ADDR        ADDR_FLASH_PAGE_0
#define END_FLASH_ADDR        ((U32)0x08040000)

#define CONFIRM_BOOT_PARAM ((U32)0x6ABCD124)
...
enum 
{
  FLASHIF_OK = 0,
  FLASHIF_ERASE_FAIL,
  FLASHIF_WRITING_AND_READ_NOT_MATCH,
  FLASHIF_WRITING_ERROR,
  
  FLASHIF_OVER_FLASH_SIZE,
};
...
FLASH_IF_EXT U32 FLASH_If_ParamAreaErase(U32 start);
FLASH_IF_EXT U32 FLASH_If_AppAreaErase(U32 start);
FLASH_IF_EXT U32 FLASH_If_WriteWord(U32 FlashAddress, U32 size, U16 *Data);
FLASH_IF_EXT void FLASH_If_ReadWord(U32 FlashAddress, U32 size, U8 *Data);
